...
if(isset($_REQUEST['btn_register'])) //compruebe el nombre del botón "btn_register" y configúrelo
{
	...
	{	
		try
		{	
			$select_stmt=$pdo->prepare("SELECT username, email FROM tblusuarios 
			...
			{
				$insert_stmt=$pdo->prepare("INSERT INTO tblusuarios(username,email,password,role) VALUES(:uname,:uemail,:upassword,:urole)"); //Consulta sql de insertar			
